...
#### di [Sergio Govoni](http://mvp.microsoft.com/profiles/Sergio.Govoni) - Microsoft MVP ([blog](http://www.ugiss.org/sgovoni/))3
...
- L’applicazione richiede un numero (valore) prima che un comando di
    INSERT sia eseguito
...
- Diversamente da una colonna IDENTITY, i cui valori tipicamente non
...
Figura 3 – Utilizzo della funzione NEXT VALUE FOR sulla sequenza
    dbo.MySequence
...
Figura 4 – Valori restituiti dalla sequenza dbo.MySequence dopo il
...
Figura 5 - Valori della sequenza dbo.MySequence in un contesto
    transazionale
