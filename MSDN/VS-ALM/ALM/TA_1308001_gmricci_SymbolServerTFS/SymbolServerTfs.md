...
![](./img//media/image1.png){width="5.21875in" height="3.375in"}

**Figura 1:** *Creare uno share di rete configurato per lettura /
scrittura*

![](./img//media/image2.png){width="6.71875in"
...
![](./img//media/image3.png){width="6.875in" height="4.34375in"}

**Figura 3:** *configurazione di una build che utilizza il build
...
![](./img//media/image4.png){width="7.75in"
height="3.9791666666666665in"}

**Figura 4:** *Il tab del processo di build con evidenziato il template
di versioning e le opzioni per la pubblicazione dei simboli.*
...
![](./img//media/image5.png){width="5.291666666666667in"
height="2.84375in"}
...
![](./img//media/image6.png){width="7.34375in"
height="4.010416666666667in"}

**Figura 6:** *Symbol server is now publishing the symbol directory to
the web with IIS*
...
![](./img//media/image7.png){width="5.666666666666667in"
height="2.2916666666666665in"}

**Figura 7:** *Creazione dell’endpoint per esporre all’esterno la porta
27000*
...
![](./img//media/image8.png){width="5.625in" height="3.0in"}
...
![](./img//media/image9.png){width="7.885416666666667in"
height="4.6875in"}
...
![](./img//media/image10.png){width="7.885416666666667in"
height="4.59375in"}
...
![](./img//media/image11.png){width="6.385416666666667in"
...
![](./img//media/image12.png){width="9.604166666666666in"
height="3.4791666666666665in"}

**Figure 12:** *Premendo F11 si è in grado di entrare in debug nei file
sorgenti usati per la compilazione della dll*
...
**Figura 12** si può notare come prima del nome del file
(myLogLibrary.cs) sia presente un numero (1046), che altro non è che il
changeset id.

![](./img//media/image13.png){width="3.7395833333333335in"
height="2.40625in"}

**Figure 13:** *L’ultima modifica fatta al file è appunto la versione
1046*
...
![](./img//media/image14.png){width="4.375in" height="2.9375in"}

**Figure 14:** *Il numero di versione identifica esattamente la build
utilizzata per compilare la dll*

**NOTA BENE**: I simboli pubblicati sono parte della build, per cui è
necessario ricordare di non cancellare mai le build usate per pubblicare
i simboli, o se le si cancella di non cancellare i relativi simboli,
altrimenti tutte le dll che avete distribuito relative a quella build,
non saranno più in grado di riconnettersi ai rispettivi sorgenti

![](./img//media/image15.png){width="7.791666666666667in"
height="4.770833333333333in"}

**Figura 15:** *Non cancellare mai i simboli di una libreria pubblicata,
oppure non si sarà più in grado di effettuare il debug.*
...
![](./img//media/image16.png){width="7.947916666666667in"
height="2.59375in"}

**Figura 16:** *Anche se si richiede di tenere solamente le ultime 10
build riuscite, si può scegliere di non cancellare mai i relativi
simboli pubblicati*
...
![](./img//media/image17.png){width="6.492361111111111in"
